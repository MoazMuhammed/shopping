              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) => ProductsWidget(discount: "${state.home!.data.productsData.first}", imageName: "${state.home!.data.productsData.first}"
                        , itemName: "${state.home!.data.productsData}", categoryName: "${state.home!.data.productsData.first}", price: "${state.home!.data.productsData.first}")
                  ),
                ),
                Padding(

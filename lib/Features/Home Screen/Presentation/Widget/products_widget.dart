...
class ProductsWidget extends StatefulWidget {
  const ProductsWidget({super.key, required this.discount, required this.imageName, required this.itemName, required this.categoryName, required this.price, required this.onPressProductDetails});
  final String discount;
  final String imageName;
  final String itemName;
  final String categoryName;
  final String price;
  final VoidCallback onPressProductDetails;
  @override
...
class _ProductsWidgetState extends State<ProductsWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: widget.onPressProductDetails,
      child: Padding(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 14.sp,
                        color: AppColors.primaryLight,overflow: TextOverflow.ellipsis),
                    maxLines: 1,
                  ),
                ),
                Padding(

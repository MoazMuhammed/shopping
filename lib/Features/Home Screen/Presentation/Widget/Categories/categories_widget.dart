...
class CategoriesWidget extends StatefulWidget {
  const CategoriesWidget({super.key, required this.imageCategory, required this.nameCategory, this.widthNameCategory, required this.onPressCategory});
  final String imageCategory;
  final String nameCategory;
  final double? widthNameCategory;
  final VoidCallback onPressCategory;
